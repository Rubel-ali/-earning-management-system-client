...
export const baseApi = createApi({
    ...
    endpoints: () => ({}),
    tagTypes: ["approveEvent", "allPosts", "logIn", "transaction", "allUsers", "allCreators", "complains", "allSummary", "activityLog", "allStaff", "allServices","allAppointments", "allQueue", "allMemories"],
});
